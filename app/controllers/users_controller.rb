class UsersController < ApplicationController
  before_filter :authenticate_user!, :except => [:profile, :search]
  load_and_authorize_resource
  skip_load_and_authorize_resource :only => [:profile, :search]
  ...
  #   -page where a user schedules an appointment with a tech
  #
  # * *Args*    :
  #   - +tech_id+ -> Technician's ID
  # * *Returns* :
  #   - the schedule page with a @tech assign
  # * *Raises* :
  #   - +redirection+ -> if the tech's ID is your own ID
  #
  def schedule_appointment
    @appoitnment = Appointment.new
